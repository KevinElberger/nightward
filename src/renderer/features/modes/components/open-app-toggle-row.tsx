...
export function OpenAppToggleRow({
  ...
  return (
    <div className="grid gap-3 py-3.5 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center sm:gap-4">
      <div className="flex items-start gap-3">
        <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-[6px] border border-surface-border bg-surface-control text-white/62 shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]">
          {icon}
        </span>
