      ...
      <div className="min-w-0 space-y-2">
        <div className="flex max-w-full items-center justify-end gap-3">
          <span className="flex min-w-0 max-w-[16rem] items-center justify-end gap-2">
            <span className="flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-[7px] border border-surface-border-subtle bg-white/[0.035] text-white/48 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
              {appIconDataUrl !== null ? (
                <img
                  src={appIconDataUrl}
                  alt=""
